...
class StoreView extends Component {
    ...
    render() {
        ...
        if (this.state.storeInfo.length > 0) {
            document.getElementById("storeName").innerHTML = this.state.storeInfo[0].storeName;
            document.getElementById("storeAddress").innerHTML = this.state.storeInfo[0].city + " | " +
                this.state.storeInfo[0].street + " | " +
                this.state.storeInfo[0].state + " | " +
                this.state.storeInfo[0].zip;
            document.getElementById("ice_level").innerHTML = "Ice Levels: " + (this.state.storeInfo[0].ice_level).toUpperCase();
            document.getElementById("sugar_level").innerHTML = "Sugar Levels: " + this.state.storeInfo[0].sugar_level;
        }
        ...
        return (
            <Container className="componentBody">
                ...
                <Container className="form">
                    <Image className="form" src="/tiger-boba-logo.jpeg" width="100px" thumbnail />
                ...
                <Container>
                    <Container className="form" className="list-group"> Drink Options:
                        <h6 id="ice_level" className="list-group-item">Category 1</h6>
                        <h6 id="sugar_level" className="list-group-item">Category 2</h6>
                    </Container>
                </Container>
